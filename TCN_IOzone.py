...
def get_x_y():
    ...
    # 读取数据
    input_data_x = pd.read_excel(r'./IOzone.xlsx', sheet_name='Sheet1', header=None)
    input_data_y = pd.read_excel(r'./IOzone_energy.xlsx', sheet_name='Sheet1', header=None)
...
outputfile1 = "Predict_IOzone_energy.xlsx"
df_data1.to_excel(outputfile1)

df_data2 = pd.DataFrame(test_y)
outputfile2 = "True_IOzone_energy.xlsx"
